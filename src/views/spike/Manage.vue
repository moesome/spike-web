<template>
    <div>
        <router-link to="/spikes/create"><a-button type="primary" icon="plus" style="margin-bottom: 10px"></a-button></router-link>
        <a-table
                :columns="columns"
                :dataSource="data"
                :loading="loading"
...
<script>
    ...
    export default {
        ...
        methods:{
            modify(record){
                this.$router.push({ name: 'edit', params: { id: record.id }});
            },
